...
//         },
//       };
//       const result = await controller.handleCreateRequest(request, await auth.apiAuthorize(request));
...
//         },
//       };
//       const result = await controller.handleUpdateRequest(request, await auth.apiAuthorize(request));
//       expect(storeCreate).toHaveBeenCalledWith({
//         owner: did,
//         schema: PROFILE_SCHEMA,
//         meta: undefined,
...
//       try {
//         await controller.handleExecuteRequest(request, await auth.apiAuthorize(request));
...
//       const profile = queryReturnProfile();
//       const response = await controller.handleReadRequest(request, await auth.apiAuthorize(request));
...
//       queryReturnEmpty();
//       const response: any = await controller.handleReadRequest(request, await auth.apiAuthorize(request));
//       expect(storeQuery).toHaveBeenCalledWith({
//         owner: did,
//         schema: PROFILE_SCHEMA,
//       });
