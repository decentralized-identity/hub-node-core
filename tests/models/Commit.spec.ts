...
describe('Commit', () => {
  describe('constructor', () => {
    ...
    it('should calculate revision correctly', () => {
      ...
      // generated by `openssl dgst -sha256 -hex
      // pasting in .foo
      // and pressing CNTL + SHIFT + D
